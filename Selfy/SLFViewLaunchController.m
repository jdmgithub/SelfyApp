...
@interface SLFViewLaunchController ()
{
...
@implementation SLFLaunchViewController
...
//         UIAlertViewStyleLoginAndPasswordInput = [[UIAlertViewStyleLoginAndPasswordInput alloc]
...
//         UIAlertViewStyleLoginAndPasswordInput * alert = [[UIAlertViewStyleLoginAndPasswordInput alloc] init
         ...
         UIAlertView * alertView = [[UIAlertView alloc] initWithTitle:@"Login Error" message:@"Invalid Username or Password" delegate:self cancelButtonTitle:@"Try Again" otherButtonTitles:nil];
...
- (void)startAnimating
{
    ...
    UIActivityIndicatorView * gear = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(100, 100, 40, 40)];
